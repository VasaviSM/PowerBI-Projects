...
Sales quantity, discount & revenue metrics
...
Specific states consistently achieve sales targets, indicating strong regional strategy.

A small group of customers contributes a significant portion of sales (Pareto Principle).

Increasing discount levels directly impacts profitability — simulation helps optimize pricing decisions.
...
Use slicers (Year, Region, Segment, Discount %) to explore insights.
